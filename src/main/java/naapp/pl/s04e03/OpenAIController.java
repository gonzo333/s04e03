...
public class OpenAIController {
    ...
    public ResponseEntity<?> handlePrompt(@RequestBody Map<String, String> request) {
        ...
        String prompt = request.getOrDefault("prompt", "ok teraz jest tak, mam obraz składający się z 16 kwadratów w układzie 4 na 4\n" +
                ...
                "Jeśli instrukcja będzie taka: 'Dobra. To co? zaczynamy? Odpalam silniki. Czas na kolejny lot. Jeste? moimi oczami. Lecimy w d??, albo nie! nie! czekaaaaj. Polecimy wiem jak. W prawo i dopiero teraz w d??. Tak b?dzie OK. Co widzisz?' to zwróć Wiatrak drewniany" +
                "");
